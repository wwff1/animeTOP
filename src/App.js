            ...
            <div className="app">
                <Container fluid style={{"display": this.state.generationStatus === 0 ? "block" : "none"}}>
                    ...
                    <Row className="margin">
                        ...
                        <Col xs="12" md="8" lg="6">
                            <Form>
                                <Form.File accept="image/*" label={(this.state.uploaded ? "Выберите изображение" : "Загрузить изображение")} onChange={this.onUpload} multiple={false} custom />
                            </Form>
                    ...
                    <Row className="margin">
                        ...
                        <Col xs="12" md="8" lg="6" style={{textAlign: "center"}}>
                            <Form>
                                ...
                                {/*    </Form.Control>*/}
                                {/*</Form.Group>*/}
                                <Button variant="primary" onClick={this.generate}>Сгенерировать</Button>
                            </Form>
                        </Col>
                        <Col/>
                    </Row>
